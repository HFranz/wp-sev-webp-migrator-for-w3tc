...
const SEVWMFW3TC_VERSION = '2.3.0';
...
require_once plugin_dir_path( __FILE__ ) . 'includes/class-options-replacer.php';
...
add_action(
	...
	static function () {
		...
		add_action( Processor::DEFERRED_DELETION_HOOK, array( $processor, 'handle_deferred_deletion' ), 10, 2 );
